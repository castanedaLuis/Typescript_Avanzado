/**
 * No necesitamos instanciar para acceder a sus metodos y propiedades
 */
...
class MyMath {
  static readonly PI = 3.14;  // solo se puede obtener y es solo lectura (no se puede modificar)
